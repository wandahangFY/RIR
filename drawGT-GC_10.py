...
if __name__=="__main__":
    src_dir= r"D:\wan\BaiduNetdiskDownload\GC_10\image_GC_10"
    save_dir=r"D:\wan\BaiduNetdiskDownload\GC_10\image_GC_10-GT-2"
    ...
    names=['punching hole','welding line','crescent gap','water spot','oil spot','silk spot','inclusion','rolled pit','crease','waist folding']
    for txt_path in dir_list:
        ...
        h, w = img.shape[:2]
        annotator = Annotator(img, line_width=12, example=str(names))
        for x in lb:
