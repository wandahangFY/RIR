...
if __name__=="__main__":
    src_dir= r"D:\wan\BaiduNetdiskDownload\SIMD\SIMD\images\paper_test_GT"
    save_dir=r"D:\wan\BaiduNetdiskDownload\SIMD\SIMD\images\paper_test_GT_OUT"
    ...
    names = ['car', 'truck', 'Van_body', 'limousine', 'bus', 'ariliner', 'propeller-driven_aircraft', 'training_plane',
     'chartered_airplane', 'warcraft', 'others', 'stairs_car', 'trailer', 'helicopter', 'boat']
