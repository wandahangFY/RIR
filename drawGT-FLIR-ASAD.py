...
if __name__=="__main__":
    src_dir= r"D:\wan\BaiduNetdiskDownload\FLIR_ADAS\image_FLIR_ADAS_16"
    save_dir=r"D:\wan\BaiduNetdiskDownload\FLIR_ADAS\image_FLIR_ADAS_16-GT"
    ...
    names=['person', 'bicycle', 'car', 'motorcycle', 'bus', 'train', 'truck', 'traffic light', 'fire hydrant', 'stop sign', 'dog', 'horse', 'skateboard', 'refrigerator', 'clock', 'hair drier']
